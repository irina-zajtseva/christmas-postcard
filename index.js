import{A as Y,a as k,S as U,N as F,P as W,i as p,b as N}from"./assets/vendor-CyB7JiL4.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&o(l)}).observe(document,{childList:!0,subtree:!0});function s(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(n){if(n.ep)return;n.ep=!0;const r=s(n);fetch(n.href,r)}})();const A=document.getElementById("mobile-menu"),K=document.getElementById("data-burger-close"),X=document.getElementById("data-burger-open"),j=document.querySelector(".mobile-menu");function D(e){e.key==="Escape"&&A.classList.contains("is-open")&&H()}function G(e){e.target.closest("a")&&H()}function H(){A.classList.remove("is-open"),document.body.style.overflow="visible",document.removeEventListener("keydown",D),j.removeEventListener("click",G)}function J(){A.classList.add("is-open"),document.body.style.overflow="hidden",document.addEventListener("keydown",D),j.addEventListener("click",G)}K.addEventListener("click",H);X.addEventListener("click",J);const Q=[{question:"Я мрію про пухнастика! Що мені потрібно зробити, щоб забрати хвостика додому?",answer:`
